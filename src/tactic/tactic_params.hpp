...
struct tactic_params {
  ...
  static void collect_param_descrs(param_descrs & d) {
    ...
    d.insert("collect_statistics.to_file", CPK_BOOL, "writes statistics to the file.", "false","tactic");
  }
  /*
  ...
  */
  ...
  bool collect_statistics_to_file() const { return p.get_bool("collect_statistics.to_file", g, false); }
};
#endif
